...
class TestFsxPathCopyToFsxPath(FsxPathBaseTest):
    def test_copy_from_fsxpath(self):
        # before state
        fpath_dir_source = FsxPath(fpath_prefix, "copy_to_fsxpath", "source")
        fpath_dir_target = FsxPath(fpath_prefix, "copy_to_fsxpath", "target")
        ...
        fpath_file_source_log_txt.copy_to(fpath_file_target_log_txt)
        ...
        fpath_dir_source_datalake.copy_to(fpath_dir_target_datalake)
